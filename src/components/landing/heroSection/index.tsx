const Hero = () => {
    return (
        <section className="relative w-full h-screen overflow-hidden text-center">
            ...
            <h1 className="w-full absolute mx-auto bottom-1/8 lg:bottom-28 font-cronosExtraLight font-normal text-white text-2xl md:text-5xl mt-4 leading-2 lg:!leading-[55px] z-10">
