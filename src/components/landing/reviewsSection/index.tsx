                ...
                {reviews.map((review, index) => (
                    <SwiperSlide key={index}>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 bg-white rounded-lg shadow-sm border border-gray300 w-full ">
                            <div className="relative h-[300px] lg:h-[350px] bg-[url(/assets/reviews/review-1-min.png)] bg-no-repeat bg-cover">
                                <img src={review.img} className={`absolute bottom-0 h-full lg:h-full rounded-lg ${index === 0 || index === 3 ? " left-10 lg:left-12": " left-8 lg:left-8"}`} alt="kheyti review" />
                            </div>
